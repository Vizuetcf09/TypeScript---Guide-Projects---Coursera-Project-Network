...
//
var name22 = "Inittialised let name22";
...
function x1FunctionScope() {
    // console.log("var global scope", x);
    var x1 = 200; // var: x function scope
    if (true) {
...
//
var name3 = "Inittialised const name3";
//
// const variables cannot be update or re-declared
//
var name33 = "Inittialised const name33";
...
function x2FunctionScope() {
    ...
    var xconst = 200; // const: x function scope
    xvar;
